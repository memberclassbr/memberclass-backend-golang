...
func (uc *AITenantUseCaseImpl) ProcessLessonsTenant(ctx context.Context, req lesson.ProcessLessonsTenantRequest) (*lesson2.ProcessLessonsTenantResponse, error) {
	if req.TenantID == "" {
	...
	lessonsReq := ai.GetAILessonsRequest{
...
func (uc *AITenantUseCaseImpl) buildPayload(lessons []ai2.AILessonData, tenantID string) dto.TranscriptionJobRequest {
