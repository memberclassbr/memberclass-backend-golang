...
type mockLessonRepository struct {
	...
	pdfPages          map[string][]*lessons.LessonPDFPage
	createPageCalls   int
...
func newMockLessonRepository() *mockLessonRepository {
	return &mockLessonRepository{
		...
		pdfAssets: make(map[string]*lessons.LessonPDFAsset),
		pdfPages:  make(map[string][]*lessons.LessonPDFPage),
	}
}

func (m *mockLessonRepository) GetByID(ctx context.Context, id string) (*lessons.Lesson, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *mockLessonRepository) GetByIDWithPDFAsset(ctx context.Context, id string) (*lessons.Lesson, error) {
	return m.GetByID(ctx, id)
}

func (m *mockLessonRepository) GetPendingPDFLessons(ctx context.Context, limit int) ([]*lessons.Lesson, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
	var pending []*lessons.Lesson
...
func (m *mockLessonRepository) Update(ctx context.Context, lesson *lessons.Lesson) error {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *mockLessonRepository) GetPDFAssetByLessonID(ctx context.Context, lessonID string) (*lessons.LessonPDFAsset, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *mockLessonRepository) CreatePDFAsset(ctx context.Context, asset *lessons.LessonPDFAsset) error {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *mockLessonRepository) UpdatePDFAsset(ctx context.Context, asset *lessons.LessonPDFAsset) error {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.pdfAssets[asset.ID] = asset
	return nil
...
func (m *mockLessonRepository) GetPDFAssetByID(ctx context.Context, assetID string) (*lessons.LessonPDFAsset, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *mockLessonRepository) GetPDFPageByAssetAndNumber(ctx context.Context, assetID string, pageNumber int) (*lessons.LessonPDFPage, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *mockLessonRepository) CreatePDFPage(ctx context.Context, page *lessons.LessonPDFPage) error {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *mockLessonRepository) GetPDFPagesByAssetID(ctx context.Context, assetID string) ([]*lessons.LessonPDFPage, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
	pages, exists := m.pdfPages[assetID]
	if !exists {
...
func (m *mockLessonRepositoryWithError) GetByID(ctx context.Context, id string) (*lessons.Lesson, error) {
	return nil, assert.AnError
}

func (m *mockLessonRepositoryWithError) GetByIDWithPDFAsset(ctx context.Context, id string) (*lessons.Lesson, error) {
	return nil, assert.AnError
}

func (m *mockLessonRepositoryWithError) GetPendingPDFLessons(ctx context.Context, limit int) ([]*lessons.Lesson, error) {
	return nil, assert.AnError
}

func (m *mockLessonRepositoryWithError) Update(ctx context.Context, lesson *lessons.Lesson) error {
	return assert.AnError
}

func (m *mockLessonRepositoryWithError) GetPDFAssetByLessonID(ctx context.Context, lessonID string) (*lessons.LessonPDFAsset, error) {
	return nil, assert.AnError
}

func (m *mockLessonRepositoryWithError) CreatePDFAsset(ctx context.Context, asset *lessons.LessonPDFAsset) error {
	return assert.AnError
}

func (m *mockLessonRepositoryWithError) UpdatePDFAsset(ctx context.Context, asset *lessons.LessonPDFAsset) error {
	return assert.AnError
}
...
func (m *mockLessonRepositoryWithError) GetPDFAssetByID(ctx context.Context, assetID string) (*lessons.LessonPDFAsset, error) {
	return nil, assert.AnError
}

func (m *mockLessonRepositoryWithError) GetPDFPageByAssetAndNumber(ctx context.Context, assetID string, pageNumber int) (*lessons.LessonPDFPage, error) {
	return nil, assert.AnError
}

func (m *mockLessonRepositoryWithError) CreatePDFPage(ctx context.Context, page *lessons.LessonPDFPage) error {
	return assert.AnError
}

func (m *mockLessonRepositoryWithError) GetPDFPagesByAssetID(ctx context.Context, assetID string) ([]*lessons.LessonPDFPage, error) {
	return nil, assert.AnError
}
