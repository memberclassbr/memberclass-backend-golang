...
func (m *MockCommentUseCase) UpdateAnswer(ctx context.Context, commentID, tenantID string, req comments.UpdateCommentRequest) (*comment.CommentResponse, error) {
...
func (m *MockCommentUseCase) GetComments(ctx context.Context, tenantID string, req *comments.GetCommentsRequest) (*comment.CommentsPaginationResponse, error) {
	args := m.Called(ctx, tenantID, req)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*comment.CommentsPaginationResponse), args.Error(1)
}
...
func TestCommentHandler_GetComments_Success(t *testing.T) {
	...
	response := &comment.CommentsPaginationResponse{
		Comments: []comment.CommentResponse{
			*comments[0],
		},
	...
	var result comment.CommentsPaginationResponse
...
func TestCommentHandler_UpdateComment_Success(t *testing.T) {
	...
	requestBody := comments.UpdateCommentRequest{
...
func TestCommentHandler_UpdateComment_CommentNotFound(t *testing.T) {
	...
	mockUseCase.On("UpdateAnswer", mock.Anything, commentID, tenantID, requestBody).Return(nil, comment2.ErrCommentNotFound)
...
func TestCommentHandler_UpdateComment_AnswerRequired(t *testing.T) {
	...
	mockUseCase.On("UpdateAnswer", mock.Anything, commentID, tenantID, requestBody).Return(nil, comment2.ErrAnswerRequired)
