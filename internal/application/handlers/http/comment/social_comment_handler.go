...
type SocialCommentHandler struct {
	useCase comment.SocialCommentUseCase
	logger  ports.Logger
}

func NewSocialCommentHandler(useCase comment.SocialCommentUseCase, logger ports.Logger) *SocialCommentHandler {
...
func (h *SocialCommentHandler) CreateOrUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	var req comments.CreateSocialCommentRequest
