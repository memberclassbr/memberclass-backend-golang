...
func TestSocialCommentHandler_CreateOrUpdatePost_Success_Create(t *testing.T) {
	...
	reqBody := request.CreateSocialCommentRequest{
		UserID:  "user-123",
		TopicID: "topic-456",
		Title:   "Test Post",
	...
	responseData := &response.SocialCommentResponse{
		OK: true,
		ID: "post-789",
	}
	...
	var result response.SocialCommentResponse
...
func TestSocialCommentHandler_CreateOrUpdatePost_UserNotFound(t *testing.T) {
	...
	mockUseCase.On("CreateOrUpdatePost", mock.Anything, reqBody, tenantID).Return(nil, usecases.ErrUserNotFoundOrNotInTenantForPost)
...
func TestSocialCommentHandler_CreateOrUpdatePost_PostNotFound(t *testing.T) {
	...
	mockUseCase.On("CreateOrUpdatePost", mock.Anything, reqBody, tenantID).Return(nil, usecases.ErrPostNotFound)
...
func TestSocialCommentHandler_CreateOrUpdatePost_TopicNotFound(t *testing.T) {
	...
	mockUseCase.On("CreateOrUpdatePost", mock.Anything, reqBody, tenantID).Return(nil, usecases.ErrTopicNotFound)
