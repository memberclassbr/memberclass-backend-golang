...
type AITenantHandler struct {
	useCase ai.AITenantUseCase
	logger  ports.Logger
}

func NewAITenantHandler(useCase ai.AITenantUseCase, logger ports.Logger) *AITenantHandler {
...
func (h *AITenantHandler) ProcessLessonsTenant(w http.ResponseWriter, r *http.Request) {
	...
	var req lesson.ProcessLessonsTenantRequest
