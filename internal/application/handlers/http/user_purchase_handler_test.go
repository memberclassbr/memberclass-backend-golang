...
func TestUserPurchaseHandler_GetUserPurchases_Success(t *testing.T) {
	...
	purchases := []response.UserPurchaseData{
		{
			ID:        "event-123",
			Type:      "purchase",
	...
	purchaseResponse := &response.UserPurchasesResponse{
		Purchases: purchases,
	...
	var result response.UserPurchasesResponse
...
func TestUserPurchaseHandler_GetUserPurchases_UserNotFound(t *testing.T) {
	...
	mockUseCase.On("GetUserPurchases", mock.Anything, mock.Anything, tenantID).Return(nil, usecases.ErrUserNotFoundOrNotInTenantForPurchases)
...
func TestUserPurchaseHandler_GetUserPurchases_EmptyResults(t *testing.T) {
	...
	emptyResponse := &response.UserPurchasesResponse{
		Purchases: []response.UserPurchaseData{},
		Pagination: response.Pagination{
			Page:        1,
			Limit:       10,
