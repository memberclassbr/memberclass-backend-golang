...
func NewRateLimiterTenant(cache cache.Cache, log logger.Logger) TenantLimiter {
...
func (r *RateLimiterTenantImpl) CheckLimit(ctx context.Context, tenantID string, endpoint string) (bool, Info, error) {
...
func (r *RateLimiterTenantImpl) checkLimit(ctx context.Context, key string, limit int, window time.Duration) (bool, Info, error) {
