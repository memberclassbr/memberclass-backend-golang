...
func (_m *MockCommentUseCase) UpdateAnswer(ctx context.Context, commentID string, tenantID string, req request.UpdateCommentRequest) (*dto.CommentResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, request.UpdateCommentRequest) (*dto.CommentResponse, error)); ok {
		return rf(ctx, commentID, tenantID, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, request.UpdateCommentRequest) *dto.CommentResponse); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, request.UpdateCommentRequest) error); ok {
...
func (_c *MockCommentUseCase_UpdateAnswer_Call) Run(run func(ctx context.Context, commentID string, tenantID string, req request.UpdateCommentRequest)) *MockCommentUseCase_UpdateAnswer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(request.UpdateCommentRequest))
	})
	return _c
}
...
func (_c *MockCommentUseCase_UpdateAnswer_Call) RunAndReturn(run func(context.Context, string, string, request.UpdateCommentRequest) (*dto.CommentResponse, error)) *MockCommentUseCase_UpdateAnswer_Call {
	_c.Call.Return(run)
	return _c
}
